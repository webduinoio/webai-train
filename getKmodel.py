...
for root, dirs, files in walk(path):
	if len(dirs)==0:
		...
		shutil.copy(root+"/"+labels_blockly , "/content/drive/MyDrive/webai-train/"+destName+"."+labels_blockly)
		if modelType == "detector":
			shutil.copy(root+"/"+anchor , "../kmodels/"+destName+"."+anchor)
			shutil.copy(root+"/"+anchor , "/content/drive/MyDrive/webai-train/"+destName+"."+anchor)
