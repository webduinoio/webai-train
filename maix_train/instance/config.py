...
ncc_kmodel_v3 = "/data/ncc_v0.1/ncc"

sample_image_num = 10       # convert kmodel sample image (for quantizing)
...
classifier_train_batch_size = 3 
classifier_train_max_classes_num = 5
classifier_train_one_class_min_img_num = 15            # 一个类别中至少需要的样本数量
...
detector_train_one_class_min_img_num = 15            # 一个类别中至少需要的样本数量
